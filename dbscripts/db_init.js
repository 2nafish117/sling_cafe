...
// db.employees.createIndex({"name": "text", "email": "text", "employee_id": "text"})
// db.admins.createIndex({"name": "text", "email": "text", "admin_id": "text"})
// db.caterers.createIndex({"name": "text", "email": "text", "caterer_id": "text"})
